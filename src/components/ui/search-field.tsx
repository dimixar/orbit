...
/**
 * Search field — Intent UI's SearchField composed on the project's
 * InputGroup/Input. The clear button self-wires: React Aria's SearchField
 * injects clearButtonProps into any Button rendered inside it, and the
 * button hides itself while the field is empty (`group-empty`).
 */

...
# binary, so use this script when testing notifications. The bundle matches
# what scripts/make-dmg.sh ships, ad-hoc signed with the production bundle id.
#
set -euo pipefail
...
APP="target/package/Orbit Pi Dev.app"

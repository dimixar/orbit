...
crates/orbit-pi/        GPUI app — window, shell, chat, settings
  ...
  src/app/updater_ui.rs signed-updater rows (General + About), pill, and event drain
